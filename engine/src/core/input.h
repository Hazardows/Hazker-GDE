...
// Keyboard input
HAPI b8 input_key_down(keys key);
HAPI b8 input_key_up(keys key);
...
HAPI void input_get_mouse_possition(i32* x, i32* y);
HAPI void input_get_previus_mouse_possition(i32* x, i32* y);
